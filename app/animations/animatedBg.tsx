...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  // Smooth lerp factor (0.02-0.1 for smooth, 0.5-1 for snappy)
  ...
  useEffect(() => {
    ...
    // Mouse interaction - set target position for smooth lerping
    ...
    const animate = (currentTime: number) => {
      ...
      if (deltaTime >= frameTime) {
        ...
        if (interactive) {
          ...
          currentMouse.x += (targetMouse.x - currentMouse.x) * MOUSE_LERP_FACTOR;
          currentMouse.y += (targetMouse.y - currentMouse.y) * MOUSE_LERP_FACTOR;
          
          materialRef.current.uniforms.uMouse.value = currentMouse;
        }
